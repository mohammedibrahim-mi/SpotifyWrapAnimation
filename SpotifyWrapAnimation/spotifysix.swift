...
//  testapp
//
//  Created by Pixel on 11/12/24.
//


import SwiftUI

struct SpotifyFavieww: View {
...
//                        .foregroundColor(.black)
                ...
                NavigationLink(destination: SpotifyWrappedView(), isActive: $navigateToNextPage) {
                                  EmptyView()
                              }
            }
            .onAppear {
...
// Preview
struct SpotifyFavieww_Previews: PreviewProvider {
